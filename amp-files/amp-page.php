<?php
/**
 * Template para exibição de Pages em Dispositivos Móveis AMP
 *
    ...
    <div class="amp-content">
      <div class="amp-wp-title-bar">
        <a href="<?php echo get_home_url(); ?>">
          <amp-img
          src="<?php echo get_stylesheet_directory_uri(); ?>/img/amp/logoamp.jpg"
          srcset="<?php echo get_stylesheet_directory_uri().'/img/amp/logoamp.jpg 640w, '.get_stylesheet_directory_uri().'/img/amp/logoamp.jpg 320w'; ?>"
          width="200"
          height="88">
          </amp-img>
        </a>
